...
public class SampleMod {
    ...
    public static Brock misaildoropper;
    ...
    public void preInit(FMLPreInitializationEvent event) {
		...
		.setContainerItem(tile.Misail)/*クラフト時にアイテムを返却できるようにしている際の返却アイテムの指定。*/
...
misaildoropper = new misaildoropper();
        //ブロックの登録。登録文字列はMOD内で被らなければ何でも良い。
 
        GameRegistry.registerBlock(misaildoropper, misaildoropper.class, "misaildoropper");
